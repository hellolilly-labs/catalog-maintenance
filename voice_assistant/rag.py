...
class PineconeRAG:
    ...
    @staticmethod
    async def rag_query_pinecone(query: str, account:str=None, index_name: Optional[str]=None, _embedding_model: Optional[str]=None, namespaces: Optional[List[str]]=None, top_k: int = 25, top_n: int = 10, min_score: float = 0.015, min_n: int = 0, use_ranked: bool = False) -> List[dict]:
        ...
        if not hasattr(PineconeRAG, "_instance"):
            ...
            rag = PineconeRAG(index_name=index_name, model_name="llama-text-embed-v2", debug=False, account=account)
